...
def get_date_years_ago(years):
    return (
        datetime.datetime.now() - relativedelta.relativedelta(years=years)
...
class TestCompountRules(TestCase):
    ...
    def test_kind_is_tussen_2_en_18_jaar(self):
        ...
        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(1)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(19)
        self.assertFalse(get_result())
        ...
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(3)
        self.assertTrue(get_result())

        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(2)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(18)
        self.assertTrue(get_result())

        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(11)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(16)
        self.assertTrue(get_result())

    def test_kind_is_10_11_12(self):
        fixture = self._get_tips_request_data()

        rules = [{"type": "ref", "ref_id": "8"}]
        ...
        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(12)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(5)
        self.assertTrue(get_result())

        # mixed valid / invalid
        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(10)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(14)
        self.assertTrue(get_result())
        ...
        fixture["user_data"]["BRP"]["kinderen"][0][
            "geboortedatum"
        ] = get_date_years_ago(15)
        fixture["user_data"]["BRP"]["kinderen"][1][
            "geboortedatum"
        ] = get_date_years_ago(22)
        self.assertFalse(get_result())
    ...
    def test_nationaliteit(self):
        ...
        fixture["user_data"]["BRP"]["persoon"]["nationaliteiten"][0] = {
